      ...
      <aside className="sidebar" id="main-navigation">
        ...
        <nav aria-label="Main navigation">
          ...
          <button className={`nav-item ${activeView === "Grades" ? "active" : ""}`} onClick={() => selectView("Grades")}>
            ...
            <small>{gradeTargets.length ? `${gradeTargets.length} set` : "What you need"}</small>
          </button>
