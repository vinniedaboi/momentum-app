...
export const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "Nothing is fixed", detail: "Every name and weighting can be edited, ours included — syllabuses are revised, candidates are entered for different combinations, and parsers are wrong sometimes. A figure you change says what the syllabus had, one press from putting it back." },
