...
export const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "One subject at a time", detail: "Where more than one course has topics in the window, the topic split takes a subject filter — and the line above it then answers for that course: how much of your Chemistry time named a topic, out of how much Chemistry there was." },
  ...
  },
  {
    ...
    items: [
      ...
      { term: "It names its source", detail: "Where the figures are ours, the list says which syllabus they were read from — qualification, code and exam years — and links the board's own PDF, so a number you doubt is one press from the document that states it." },
      { term: "Nothing is fixed", detail: "Every name, weighting and mark total can be edited, ours included — syllabuses are revised, candidates are entered for different combinations, and parsers are wrong sometimes. A figure you change says what the syllabus had, one press from putting it back." },
